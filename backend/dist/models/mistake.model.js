...
const MistakeSchema = new mongoose_1.Schema({
    ...
    attemptId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Attempt', required: true },
    wrongSelectedOption: { type: String, enum: ['A', 'B', 'C', 'D', 'E'], required: true },
    notes: { type: String, trim: true },
}, { timestamps: true });
MistakeSchema.index({ userId: 1, questionId: 1 });
exports.MistakeModel = mongoose_1.default.model('Mistake', MistakeSchema);
